...
public class StageSelectManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // シーン遷移中は選択オブジェクトやEventSystemが破棄途中の可能性があるため処理しない
...
public class StageSelectManager : MonoBehaviour
{
    ...
    // Input System
    // =========================================================
    private StageSelectInputActions inputActions;

    private void Awake()
    {
        inputActions = new StageSelectInputActions();
    }

    private void OnEnable()
    {
        inputActions.Enable();
        inputActions.StageSelect.ToggleUnlockAll.performed += OnToggleUnlockAll;
    }
